...
void setup() {
  ...
  servoThumb.attach(5);//thumb
  pinMode(pinCalib, INPUT_PULLUP);//A6
  pinMode(pinExtra, INPUT_PULLUP);//A5
  pinMode(pinThumb, INPUT_PULLUP);//A4
  pinMode(pinOther, INPUT_PULLUP);//A3
}
